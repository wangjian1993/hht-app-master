	...
	<div class="app">
		...
		<div class="content" v-show="isLoading">
			...
			<div class="report-content">
				...
				<div class="report-img-1"><img src="../../assets/image/ruler@3x.png" alt="" /></div>
				...
				<div class="grow-up">
					...
					<v-radar :radarList="radarList1" :radarNuber="radarList2" v-if="radarList1.length != 0"></v-radar>
				</div>
				<div class="potential">
			...
			<div class="report-img-footer">
				<div class="report-img-2"><img src="../../assets/image/img_eraser@3x.png" alt="" /></div>
				<div class="report-img-3"><img src="../../assets/image/img_pencil@3x.png" alt="" /></div>
			</div>
		</div>
	</div>
</template>
